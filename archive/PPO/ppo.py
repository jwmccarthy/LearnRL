    ...
    def update(self):
        for _ in range(self.training_epochs):
            for minibatch in self.rollout_buffer.sample(self.minibatch_size):
                ...
                _, values, logprobs, entropy = self.policy.evaluate_actions(observations, action=actions)
                ...
                # total loss
                total_loss = policy_loss + self.val_coef * value_loss + self.ent_coef * entropy_loss
